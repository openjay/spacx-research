...
从 424B4 封面与 “The Offering” 提取并对照 S-1/A #2 锚点：最终价格（预期 $135.00）、发行股数（预期 555.6M）、绿鞋、承销价差、IPO 后总股本（预期 13,075,865,175）、招股书日期（= 解禁 Day 0 锚）、预计首日交易日（2026-06-12）。价格 ≠ $135 或股数 ≠ 555.6M → 同时执行 [C-1 重锚程序](#c-1--最终价--135重锚程序)。
